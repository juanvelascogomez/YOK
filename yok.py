...
print("                                                                                                 ")
print("          _        _______           _        _______  _______  _______  _______  _______        ")
print("         | \    /\(  ____ \|\     /|( \      (  ___  )(  ____ \(  ____ \(  ____ \(  ____ )       ")
print("         |  \  / /| (    \/( \   / )| (      | (   ) || (    \/| (    \/| (    \/| (    )|       ")
print("         |  (_/ / | (__     \ (_) / | |      | |   | || |      | |      | (__    | (____)|       ")
print("         |   _ (  |  __)     \   /  | |      | |   | || | ____ | | ____ |  __)   |     __)       ")
print("         |  ( \ \ | (         ) (   | |      | |   | || | \_  )| | \_  )| (      | (\ (          ")
print("         |  /  \ \| (____/\   | |   | (____/\| (___) || (___) || (___) || (____/\| ) \ \__       ")
print("         |_/    \/(_______/   \_/   (_______/(_______)(_______)(_______)(_______/|/   \__/       ")
print("                                                                                                 ")
...
#---------------------------------------------------
#Holding the keyboard state. 32 bytes with each bit representing the state for a single key
#---------------------------------------------------
...
key_mapping = {
    ...
    13:{
        #0b00000001: "<right ctrl>",
        #0b00000010: "<right alt>",
    },
}
...
def fetch_keys():
    ...
    #caps lock states
    if ord(keypresses_raw[0]) & 4:caps_lock_state = int(not caps_lock_state)
